...
is_canceled = 1 and deposit_type = 'Non Refund'
  ...
  -- here we use the first caluculation "total revenue" to get the profit percentage of each hotel per months
  
select *, round((total_revenue_per_month/35600011.96)*100,2) as profit_percentage
from(
...
select *, round((total_revenue_per_year/35600011.96)*100,2) as profit_percentage
from
(
